...
export function LeftSidebar() {
  ...
  return (
    <aside className="w-[240px] bg-[#1a1a1a] border-r border-zinc-800/50 flex flex-col">
      {/* Tabs */}
      <div className="flex items-center border-b border-zinc-800/50 px-3">
        <button
      ...
      <div className="p-3 border-b border-zinc-800/50">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-8 pr-2.5 py-1.5 bg-zinc-900/30 border border-zinc-800/50 rounded text-xs text-white placeholder:text-zinc-600 focus:outline-none focus:border-zinc-700 transition-colors"
          />
        </div>
      </div>
      ...
      {/* New Artboard Button */}
      <div className="p-3">
        <button className="w-full flex items-center gap-2 px-3 py-2 bg-zinc-900/30 hover:bg-zinc-900/50 border border-zinc-800/50 rounded text-xs text-zinc-400 hover:text-zinc-300 transition-colors">
        ...
        {filteredNodes.length === 0 ? (
          ...
          <div className="space-y-1">
            {filteredNodes.map((node) => (
              ...
              >
                <div className="w-6 h-6 rounded bg-zinc-900 border border-zinc-800/50 flex items-center justify-center flex-shrink-0">
